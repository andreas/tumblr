...
You can cache responses from Tumblr to speed up processing or avoid downtime when Tumblr is down. Caching is provided by {HTTParty::Icebox}[https://github.com/sachse/httparty-icebox]. To enable caching:
  
  Tumblr.caching :store => :memory, :timeout => 60

You can cache to filesystem, memory and more. Read more about {parameters for the cache-method}[https://github.com/sachse/httparty-icebox/blob/master/lib/httparty-icebox.rb#L37].
